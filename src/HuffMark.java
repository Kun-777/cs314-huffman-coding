...
//        if (f.getName().endsWith(SUFFIX)) return;  // don't read .hf files!
        ...
        System.out.printf("Compression rate: %.3f", 8.0*outFile.length() / (f.length()));
        System.out.println();
    }
    ...
    public void doMark() throws IOException{
        ...
        if (action == JFileChooser.APPROVE_OPTION){
            ...
            System.out.printf("Average compression rate %.3f\n",
            8.0*myTotalCompressedBytes/(1.0*myTotalUncompressedBytes));
